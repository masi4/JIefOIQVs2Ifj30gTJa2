...
{
    public PlayerModel(int width, int height, int worldGravity, int initialJumpSpeed, int horizontalVelocityGain,
    ...
    {
        // TODO: возможно убрать эту проверку, т.к. она уже есть в GUI
        if (!player.isDead())
        {
