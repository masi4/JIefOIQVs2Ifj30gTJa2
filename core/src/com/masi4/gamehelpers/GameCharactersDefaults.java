...
{
    // PLAYER
    public static final int PLAYER_DEFAULT_WIDTH = 48;
    public static final int PLAYER_DEFAULT_HEIGHT = 96;

    public static final int PLAYER_DEFAULT_INITIAL_JUMP_SPEED = 640;
    ...
    public static final float PLAYER_DEFAULT_MELEE_SWORD_ATTACK_CAST_TIME = 0.23f;
    ...
    public static final int SKELETON_DEFAULT_BLOCKING = 0;
    public static final int SKELETON_DEFAULT_BONUS_SPEED_PROCENT = 0;

    public static final float SKELETON_DEFAULT_MELEE_SWORD_ATTACK_CAST_TIME = 0.27f;
    public static final float SKELETON_DEFAULT_MELEE_SWORD_ATTACK_COOLDOWN = 0.5f;
